...
const translations: Record<Exclude<Locale, "ru">, Record<string, string>> = {
  en: {
    ...
    "Создать рабочую область": "Create workspace",
    ...
    "Создайте аккаунт, чтобы работать только со своими данными.":
      "Create an account to work only with your own data.",
    "Веб-кабинет использует Supabase Auth и хранит рабочие данные отдельно для каждого аккаунта.":
      "The web workspace uses Supabase Auth and keeps working data separate for each account.",
  ...
  kk: {
    ...
    "Вход": "Кіру",
    "Регистрация": "Тіркелу",
    "Создать рабочую область": "Жұмыс аймағын жасау",
    "Рабочая почта": "Жұмыс поштасы",
    "Пароль": "Құпиясөз",
    "Проверяем доступ": "Қолжетімділікті тексерудеміз",
    "Создаём аккаунт": "Аккаунт жасалуда",
    "Войти": "Кіру",
    ...
    "Создайте аккаунт, чтобы работать только со своими данными.":
      "Тек өз деректеріңізбен жұмыс істеу үшін аккаунт жасаңыз.",
    "Веб-кабинет использует Supabase Auth и хранит рабочие данные отдельно для каждого аккаунта.":
      "Веб-кабинет Supabase Auth қолданады және жұмыс деректерін әр аккаунт үшін бөлек сақтайды.",
    "Выберите действие слева и опишите задачу. Growly вызовет тот же сервисный слой, который используется Telegram-ботом.":
    ...
    "Не удалось зарегистрироваться. Проверьте почту и пароль.":
      "Тіркелу мүмкін болмады. Пошта мен құпиясөзді тексеріңіз.",
    "Проверьте почту, чтобы подтвердить регистрацию.":
      "Тіркелуді растау үшін поштаңызды тексеріңіз.",
    "Нет черновиков, ожидающих согласования.":
